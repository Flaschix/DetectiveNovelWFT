        ...
        this.characters = [
            ...
            },
            {
                ...
                answers: [
                    ...
                    'О, это были недоразумения. Я просто делал зарисовки и изучал экспонаты для своих проектов.',
                    'Ну... Что-то вроде расследований. Я изучаю случаи пропаж редких экспонатов. Видите ли, такого рода дела явно расследуются хуже, чем, например, серийные убийства. Но кто-то должен этим заняться, не так ли?'
                ]
            },
            {
