...
export class GameScene extends Phaser.Scene {
    constructor() {
        ...
        this.characters = [
            { avatar: "character1", name: 'Анна', dialog: 'Здравствуйте! О чем вы хотели поговорить со мной?', questions: ['Почему вас видели грустной на улице в 21:15?', 'Как прошел ваш рабочий день в музее?', 'Есть ли у вас проблемы, которые могут повлиять на вашу работу?', 'Вы заметили что-то необычное в музее в тот вечер?', 'Где вы были, когда произошла кража?'], answers: ['Да, я была немного расстроена. В последнее время у меня были личные проблемы, которые меня очень тревожат.', 'День был тяжелый, много посетителей, много работы. Я очень устала. Кажется я на работе оставила свою сумку и очки.', 'У меня возникли финансовые трудности из-за болезни матери. Но я стараюсь не приносить свои проблемы на работу.', 'В музее было довольно тихо, ничего подозрительного я не заметила.', 'Я уже уходила с работы и была на улице, когда произошла кража.'] },
            {
                avatar: "character2", name: 'Виктор', dialog: 'Что вам нужно?',
                questions: [
                    'Где вы были вечером, когда произошла кража?',
                    'Почему вас видели на улице в 21:10, куда вы спешили?',
                    'Вы видели что-то подозрительное в музее перед выходом?',
                    'Какие у вас были планы на вечер?',
                    'Почему вы не сообщили о порванных штанах своему начальству?'
                ],
                answers: [
                    'Я был на улице, бежал в ателье зашить штаны. Они порвались прямо на работе, и я хотел привести себя в порядок перед встречей.',
                    'Говорю же, зашить штаны! У меня была важная встреча с почти уже бывшей женой, а я опаздывал.',
                    'Ничего я не видел. Что-то ещё?',
                    'О, просто грандиозные. Встреча с женой и адвокатом по бракоразводным процессам.',
                    'Какое ваше дело? Спешил я. Довольны?'
                ]
            },
            {
                avatar: "character3", name: 'Сэм', dialog: 'Что такое?',
                questions: [
                    'Почему вас видели в 21:25 в белом халате с чехлом от гитары?',
                    'Что вы делали в музее вечером?',
                    'У вас есть какие-то особые планы на будущее, связанные с вашей работой?',
                    'Есть ли у вас идеи, зачем кому-то может понадобиться красть эту картину?',
                    'В какую стоимость вы бы оценили пропавшую картину?'
                ],
                answers: [
                    'Я возвращался в свою мастерскую после небольшого перерыва. Чехол от гитары использую для хранения некоторых инструментов.',
                    'Я задержался в музее, чтобы завершить работу над одним из проектов. Иногда работа требует дополнительного времени.',
                    'Я всегда стремлюсь совершенствоваться и мечтаю о больших проектах. Надеюсь, мои труды будут по достоинству оценены.',
                    'Люди, остро нуждающиеся в деньгах, полагаю.',
                    'Её невозможно оценить в денежном эквиваленте. Она намного больше, чем просто холст и масло.  '
                ]
            },
            {
                avatar: "character4", name: 'Майкл', dialog: 'Добрый вечер. Чем могу помочь?',
                questions: [
                    'Зачем вы встретились с Айрин в музее?',
                    'Почему вас видели с рюкзаком в 21:45 на улице?',
                    'Вы оставили свой фотоаппарат и ноутбук в музее? Почему?',
                    'Что вы делали в других музеях, где вас замечали в подозрительных действиях?',
                    'И Айрин помогает вам?'
                ],
                answers: [
                    'Мы решили провести вечер в музее, чтобы насладиться искусством и провести время вместе. Мы давно планировали это свидание.',
                    'Я всегда ношу с собой рюкзак, в нем мои вещи. Ничего особенного в этом нет.',
                    'Видимо, оставил случайно. Мы были в спешке, когда уходили.',
                    'О, это были недоразумения. Я просто делал зарисовки и изучал экспонаты для своих проектов. Что-то вроде расследований. Я изучаю случаи пропаж редких экспонатов. Видите ли, такого рода дела явно расследуются хуже, чем, например, серийные убийства. Но кто-то должен этим заняться, не так ли?',
                    'Кхм, что ж, сначала мне действительно удалось выяснить много полезной информации через нее, но сейчас она и правда начинает мне нравиться.'
                ]
            },
            {
                avatar: "character5", name: 'Айрин', dialog: 'Рада помочь вам в расследовании!',
                questions: [
                    'Что вы делали в музее вечером?',
                    'Почему ваш кулон был найден в музее?',
                    'Куда вы направлялись после музея в 21:45?',
                    'Зачем вам нужно было встречаться с Майклом в музее?',
                    'О чем вы общались на свидании?'
                ],
                answers: [
                    'Мы с Майклом решили встретиться в музее, чтобы провести время вдали от лишних глаз. Мы давно планировали это.',
                    'Я даже не заметила, что потеряла кулон. Возможно, он упал, когда я снимала пальто.',
                    'Мы просто решили прогуляться после музея. Встретились на улице, чтобы обсудить планы на будущее.',
                    'Мы оба любим искусство, и музей был отличным местом для встречи. Это было просто свидание.',
                    'Мы всегда болтаем об искусстве. Хм, если подумать  ни о чем другом он меня не спрашивает...'
                ]
            },
        ];
    }
